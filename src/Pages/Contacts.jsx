...
import Popup from "../Components/Sticker"
import IcoN from '../utils/icons8-male-user.gif';
import { removeContact } from "../ReduxData/action"
                    ...
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-blue-950 rounded-lg shadow-md m-4 p-4 text-white">
                            <div onClick={() => togglePopup(el)} className="w-3/4 m-auto  ">
                                <img className="w-full rounded-full" src={IcoN} alt="" />
                                <div className="p-4">
                                    {isOpen &&
                                  ...
                                  <div className="text-left">
                                    ...
                                    <p><b>Mobile:</b>{el.mob}</p>
                                    <p><b>Status: </b>{el.status == "active" ? "Active" : "Inactive"}</p>
                                </div>
